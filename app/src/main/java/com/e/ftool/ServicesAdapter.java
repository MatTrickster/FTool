...
public class ServicesAdapter extends RecyclerView.Adapter<ServicesAdapter.ViewHolder> {
    ...
    public ServicesAdapter(Context context, ArrayList<HashMap<String,String>> list, DatabaseReference ref,String type){
    ...
    public void onBindViewHolder(@NonNull ServicesAdapter.ViewHolder holder, int position) {
        ...
        if(type.equals("c")){
            holder.removeService.setVisibility(View.GONE);
        }else {
